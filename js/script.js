    ...
    "Setor de Comunicação e Marketing": {
        "Setor de Comunicação e Marketing": {
            ...
            "Criação de Newsletter": [
                "A01: Na última sexta-feira do mês",
                "A02: Abrir o E-mail.",
            ...
            "Gestão de e-mails de Comunicação Interna": [
                "A01: Quando receber um e-mail do setor solicitando a comunicação",
            ...
            "Gestão do Site": [
                "A01: Toda terceira quinta-feira do mês",
            ...
            "Produção de Evento Externo": [
                "A01: Quando a solicitação de evento chegar ao e-mail do setor solicitando a comunicação",
                "A02: Realizar reunião",
            ...
            "Produção de Evento Interno": [
                "A01: Quando a solicitação do evento chega ao setor de marketing",
            ...
            "Solicitação Urgente de Produção de Conteúdo": [
                "A01: Quando for solicitado pelo setor comercial",
    ...
    "Setor de Contratos": {
        "Equipe de Planejamento": {
            "Reunião de Project Review": [
                "A01: Periodicidade ser definida na ata de reunião interna",
        ...
        "Gestor de Contratos": {
            ...
            "Contratação e negociação com Fornecedor": [
                "A01: Quando montar o planejamento",
            ...
            "Entrega do Projeto": [
                "A01: Quando há uma data de entrega específica",
            ...
            "Envio de Contrato para assinatura do CEO de Gestor": [
                "A01: Quando é necessário enviar contrato para CEO",
            ...
            "Fluxo de Gestão de Projeto Adaptativo": [
                "A01: Quando uma atividade vai se iniciar",
            ...
            "Gestão de Consórcios": [
                "A01: A depender das especificações do contrato (mínimo mensalmente)",
                "A02: Realizar estudo",
            ...
            "Início de Contratos": [
                "A01: Quando um contrato é ganho",
            ...
            "Processo de encerramento do contrato": [
                "A01: Quando o produto é finalizado e aprovado",
            ...
            "Reunião de Partida com Cliente": [
                "A01: Quando um projeto se inicia",
    ...
    "Setor Jurídico": { 
        "Setor Jurídico": {
            "Análise da elaboração do contrato": [
                "A01: Quando um contrato é elaborado",
            ...
            "Contratação de Terceiros": [
                "A01: Quando um contrato é fechado com o cliente",
            ...
            "Intermedição com os escritórios de advocacia": [
                "A01: Quando a empresa recebe algum documento",
            ...
            "Solicitação de seguro e garantia contratual": [
                "A01: No momento em que foi acordado",
    ...
    "Setor de GeoTecnia": { 
        "Setor de GeoTecnia": {
            ...
            "Empréstimo de equipamentos": [
                "A01: Quando há demanda de algum setor da empresa",
            ...
            "Ensaios de laboratório em campo": [
                "A01: Quando houver alguma solicitação do cliente",
            ...
            "Levantamento de topografia em drone": [
                "A01: Quando há demanda interna ou externa",
            ...
            "Processamento aerofotogramético + GNSS": [
                "A01: Quando receber os dados de campo",
    ...
    "Setor de Recursos Humanos": {
        "Setor de Recursos Humanos": {
            ...
            "Alteração de função e salário": [
                "A01: Receber formulário de movimentação pessoal assinado pelo diretor e pelo colaborador",
            ...
            "Aplicação de pesquisa de clima": [
                "A01: Quando for de acordo com o cronograma montado no inicio do ano",
            ...
            "Cadastro de Admissões de colaboradores no sistema": [
                "A01: Quando receber informação do RH",
            ...
            "Cadastro de novo funcionário para batida de ponto": [
                "A01: Quando houver nova contratação",
            ...
            "Controle e Frequência de Ponto Manual": [
                "A01: Quando fechar o período de 21 do mês atual até o dia 20 do mês seguinte",
            ...
            "Desmobilização dos estagiários": [
                "A01: Quando estiver próximo da finalização do contrato dos estagiários ou quando ele é desligado",
            ...
            "Divulgação de campanhas": [
                "A01: Quando for dia de campanha",
            ...
            "Emissão de contrato de entrada de estagiários": [
                "A01: Quando o gestor aprova contratação",
            ...
            "Entrevista de desmobilização": [
                "A01: Quando um colaborador é desligado",
            ...
            "Fechamento Mensal de benefícios": [
                "A01: Quando receber o e-mail da seguradora, com ativos, nota fiscal e boletos",
            ...
            "Formulário de avaliação de desempenho": [
                "A01: No 45º e 90º dia do colaborador na empresa",
            ...
            "Lançamento de atestado médico": [
                "A01: Quando houver emissão de atestado médico",
            ...
            "Lançamento de Notas Fiscais": [
                "A01: Quando receber nota no HelpDesk",
            ...
            "Lançamento de Notas Fiscais de estagiários": [
                "A01: Quando receber boleto da instituição de ensino",
            ...
            "Lançamento de reembolso de exames ocupacionais CLT": [
                "A01: Quando houver aprovação do gestor",
                "A02: Receber e-mail",
            ...
            "Movimentação de pessoal": [
                "A01: Quando há alguma mudança de cargo",
            ...
            "Onboard de integração de novo colaborador": [
                "A01: Quando houver um colaborador novo",
            ...
            "Onboard de reintregração": [
                "A01: Todo inicio do ano (Janeiro a março)",
            ...
            "Rescisão de contrato CLT": [
                "A01: Quando receber formulário assinado pela Diretoria e Gestão com informações, via e-mail",
            ...
            "Solicitação de adiamento da ajuda de custo para estagiário": [
                "A01: Assim que a data de admissão do estagiário for definida",
            ...
            "Triagem de candidaturas": [
                "A01: Quando receber candidaturas",
